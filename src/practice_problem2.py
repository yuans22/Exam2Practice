...
def run_test_practice_problem2a():
    ...
    # Test 2:
    expected = [6, 10, 4, -8, 14]
    actual = practice_problem2a([4, 8, 2, -10, 12], 2)
    print()
    print('Test 2 expected:', expected)
    print('       actual:  ', actual)

    # Test 3:
    expected = [26, 5, 19, 2, 18]
    actual = practice_problem2a([22, 1, 15, -2, 14], 4)
    print()
    print('Test 1 expected:', expected)
    print('       actual:  ', actual)

    # Test 4:
    expected = [37, 32, 31, -14, 18]
    actual = practice_problem2a([21, 16, 15, -30, 2], 16)
    print()
    print('Test 1 expected:', expected)
    print('       actual:  ', actual)
